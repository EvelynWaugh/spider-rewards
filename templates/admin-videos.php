...
<div class="wrap">
	<h1 class="wp-heading-inline"><?php esc_html_e( 'Video Submissions', 'spider-rewards' ); ?></h1>
	<a href="#" class="page-title-action add-new-submission" data-table="video"><?php esc_html_e( 'Add New', 'spider-rewards' ); ?></a>
	...
	<div class="spider-modal-content">
		...
		<div class="spider-modal-body">
			<form id="submission-form">
				...
				<input type="hidden" id="table-type" name="table_type" value="video">
				...
				<div class="form-field">
					<label for="order_number"><?php esc_html_e( 'Order Number', 'spider-rewards' ); ?></label>
					<input type="text" id="order_number" name="order_number">
				</div>
				
				<div class="form-field">
					<label for="content_link"><?php esc_html_e( 'Video Link', 'spider-rewards' ); ?></label>

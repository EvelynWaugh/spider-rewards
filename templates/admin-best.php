...
<div class="wrap">
	<h1 class="wp-heading-inline"><?php esc_html_e( 'Best Fit Contest Submissions', 'spider-rewards' ); ?></h1>
	<a href="#" class="page-title-action add-new-submission" data-table="best"><?php esc_html_e( 'Add New', 'spider-rewards' ); ?></a>
	...
	<div class="spider-modal-content">
		...
		<div class="spider-modal-body">
			<form id="submission-form">
				...
				<input type="hidden" id="table-type" name="table_type" value="best">
				...
				<div class="form-field">
					<label for="content_link"><?php esc_html_e( 'Content Link', 'spider-rewards' ); ?></label>

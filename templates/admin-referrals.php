...
<div class="wrap">
	<h1 class="wp-heading-inline"><?php esc_html_e( 'Friend Referrals', 'spider-rewards' ); ?></h1>
	<a href="#" class="page-title-action add-new-submission" data-table="referral"><?php esc_html_e( 'Add New', 'spider-rewards' ); ?></a>
	...
	<div class="spider-modal-content">
		...
		<div class="spider-modal-body">
			<form id="submission-form">
				...
				<input type="hidden" id="table-type" name="table_type" value="referral">
				...
				<div class="form-field">
					<label for="friend_info"><?php esc_html_e( 'Friend Info', 'spider-rewards' ); ?></label>
					<textarea id="friend_info" name="friend_info" rows="3"></textarea>
				</div>
